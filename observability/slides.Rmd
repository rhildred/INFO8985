...
Observe the running system and use [https://www.umletino.com/umletino.html](https://www.umletino.com/umletino.html) to document it with a deployment diagram. Submit the deployment diagram with the uploader at the [end of the presentation](#Upload).
